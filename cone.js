...
let cone = class {
    constructor(gl, pos) {
        this.texture = loadTexture(gl, 'cones.png');
        ...
        //     this.positions.push(0.2 * Math.cos((M_PI * i) / 180), 0.2 * Math.sin((M_PI * i) / 180), 0);
        //     this.positions.push(0.2 * Math.cos(M_PI * ((i + 360 / n) / 180)), 0.2 * Math.sin(M_PI * ((i + 360 / n) / 180)), 0);
        //     this.positions.push(0.2 * Math.cos(M_PI * ((i + 720 / n) / 180)), 0.2 * Math.sin(M_PI * ((i + 720 / n) / 180)), 0);
        //     // console.log("AAA");
        // }
