...
let dog = class {
    constructor(gl, pos) {
        ...
        for (var i = 0; i <= 360; i += 360 / n) {
            this.positions.push(0, 0.2, 0);
            this.positions.push(0.15 * Math.cos((M_PI * i) / 180), 0.2 + 0.15 * Math.sin((M_PI * i) / 180), 0);
            this.positions.push(0.15 * Math.cos(M_PI * ((i + 360 / n) / 180)), 0.2 + 0.15 * Math.sin(M_PI * ((i + 360 / n) / 180)), 0);
            this.positions.push(0.15 * Math.cos(M_PI * ((i + 720 / n) / 180)), 0.2 + 0.15 * Math.sin(M_PI * ((i + 720 / n) / 180)), 0);

            this.positions.push(0, 0.2, -2);
            this.positions.push(0.15 * Math.cos((M_PI * i) / 180), 0.2 + 0.15 * Math.sin((M_PI * i) / 180), -1);
            this.positions.push(0.15 * Math.cos(M_PI * ((i + 360 / n) / 180)), 0.2 + 0.15 * Math.sin(M_PI * ((i + 360 / n) / 180)), -1);
            this.positions.push(0.15 * Math.cos(M_PI * ((i + 720 / n) / 180)), 0.2 + 0.15 * Math.sin(M_PI * ((i + 720 / n) / 180)), -1);
        ...
        this.positions.push(0.1, 0.1, 0);
        this.positions.push(0.15, 0.1, 0);
        this.positions.push(0.15, -0.1, 0);
        this.positions.push(0.1, -0.1, 0);
        ...
        this.positions.push(0.1, 0.1, -1);
        this.positions.push(0.15, 0.1, -1);
        this.positions.push(0.15, -0.1, -1);
        this.positions.push(0.1, -0.1, -1);
